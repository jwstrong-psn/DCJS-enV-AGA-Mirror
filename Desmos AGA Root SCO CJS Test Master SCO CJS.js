...
PearsonGL.External.masterJS = (function() {
  ...
  **********************************************************************************/
  ...
  ts.A0597217_updateLabels = (val, name, desmos)=>PearsonGL.External.rootJS.A0597217_updateLabels((desmos!==undefined)?{'value':val,'name':name,'desmos':desmos,'log':console.log}:val);
