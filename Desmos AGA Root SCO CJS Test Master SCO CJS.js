...
PearsonGL.External.masterJS = (function() {
  ...
  **********************************************************************************/
  ...
  ts.A0597514_updateLabels = (val, name, desmos)=>PearsonGL.External.rootJS.A0597514_updateLabels((desmos!==undefined)?{'value':val,'name':name,'desmos':desmos,'log':console.log}:val);
   ...
   ts.A0597205_init = (val, name, desmos)=>PearsonGL.External.rootJS.A0597205_init((desmos!==undefined)?{'value':val,'name':name,'desmos':desmos,'log':console.log}:val);

  ts.A0597205_updateLabels = (val, name, desmos)=>PearsonGL.External.rootJS.A0597205_updateLabels((desmos!==undefined)?{'value':val,'name':name,'desmos':desmos,'log':console.log}:val);
