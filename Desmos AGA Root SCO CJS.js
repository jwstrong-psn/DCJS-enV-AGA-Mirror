         ...
         * ←—————————————————————————————————————————————————————————————————→ */
         changeStep: function(){
          ...
          var exprs = [
            ...
            {id:"pointCircumcenter",hidden:(gt1&&lt4),color:((lt5)?"#da2128":"#000000")}
          ...
          if(lt2) {
            ...
            exprs.push(
              ...
              }, {id:'bisectorA',color:'#da2128',latex:
          ...
          if(lt3) {
            ...
            if(lt4) {
              exprs.push(
                ...
                }, {id:'bisectorB',color:'#da2128',latex:
          ...
          if(o.value === 5) {
            exprs.push(
              {id:'circumCircle',color:'#da2128',style:cs.keyword.lineType.SOLID,latex:
            ...
            if(lt2) {
              ...
              exprs.push({id:'circumCircle',color:'#da2128',style:cs.keyword.lineType.SOLID,latex:'\\left(x-U_x\\right)^2+\\left(y-U_y\\right)^2=R^2'});
            }
          }
       ...
       fs.A0596373 = {
         ...
         * ←—————————————————————————————————————————————————————————————————→ */
         changeStep: function(){
          ...
          else if (o.value === 4) {exprs.push({id:'pointIncenter',hidden:false,color:'#da2128'});}
          ...
          if (o.value === 1) {
            ...
            exprs.push(
              {id:'inCircle',color:'#da2128',style:cs.keyword.lineType.SOLID,latex:
          ...
          if (o.value === 1) {exprs.push(
            ...
            if (o.value === 6) {exprs.push(
              {id:'pointTangents',color:'#da2128',hidden:false,latex:
          ...
          if (o.name === 'R_{unSimulation}') {
            ...
            return;
              ...
              //send the last point to Desmos.
               o.desmos.setExpression({id: '600', latex: '(' + n + ', '+ meanNetPerGame[n-1] +')', color: '#0072bc', showLabel:'true', hidden:false});
              /*————————————————————————————————————————————————-
             ...
             ——————————————————————————————————————————————————————- */
              ...
              o.desmos.setExpression({id: '601', type: 'table',
                ...
                {latex:'y',values: meanNetPerGame,color:'#0072bc', columnMode:
